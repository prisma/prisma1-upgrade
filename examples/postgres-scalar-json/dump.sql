...
--
-- Name: postgres-scalar-json$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres-scalar-json$dev";


ALTER SCHEMA "postgres-scalar-json$dev" OWNER TO root;
...
--
-- Name: User; Type: TABLE; Schema: postgres-scalar-json$dev; Owner: root
--

CREATE TABLE "postgres-scalar-json$dev"."User" (
    id character varying(25) NOT NULL
);


ALTER TABLE "postgres-scalar-json$dev"."User" OWNER TO root;

--
-- Name: User_json; Type: TABLE; Schema: postgres-scalar-json$dev; Owner: root
--

CREATE TABLE "postgres-scalar-json$dev"."User_json" (
...
ALTER TABLE "postgres-scalar-json$dev"."User_json" OWNER TO root;
...
--
-- Name: User_json User_json_pkey; Type: CONSTRAINT; Schema: postgres-scalar-json$dev; Owner: root
--

ALTER TABLE ONLY "postgres-scalar-json$dev"."User_json"
    ADD CONSTRAINT "User_json_pkey" PRIMARY KEY ("nodeId", "position");


--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: postgres-scalar-json$dev; Owner: root
--

ALTER TABLE ONLY "postgres-scalar-json$dev"."User"
...
--
-- Name: User_json User_json_nodeId_fkey; Type: FK CONSTRAINT; Schema: postgres-scalar-json$dev; Owner: root
--

ALTER TABLE ONLY "postgres-scalar-json$dev"."User_json"
    ADD CONSTRAINT "User_json_nodeId_fkey" FOREIGN KEY ("nodeId") REFERENCES "postgres-scalar-json$dev"."User"(id);
