...
--
-- Name: postgres-self-relation$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres-self-relation$dev";


ALTER SCHEMA "postgres-self-relation$dev" OWNER TO root;
...
--
-- Name: User; Type: TABLE; Schema: postgres-self-relation$dev; Owner: root
--

CREATE TABLE "postgres-self-relation$dev"."User" (
    id character varying(25) NOT NULL,
    "invitedBy" character varying(25)
);


ALTER TABLE "postgres-self-relation$dev"."User" OWNER TO root;
...
--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: postgres-self-relation$dev; Owner: root
--

ALTER TABLE ONLY "postgres-self-relation$dev"."User"
...
--
-- Name: User User_invitedBy_fkey; Type: FK CONSTRAINT; Schema: postgres-self-relation$dev; Owner: root
--

ALTER TABLE ONLY "postgres-self-relation$dev"."User"
    ADD CONSTRAINT "User_invitedBy_fkey" FOREIGN KEY ("invitedBy") REFERENCES "postgres-self-relation$dev"."User"(id) ON DELETE SET NULL;
