...
--
-- Name: postgres-table-has-many-required$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres-table-has-many-required$dev";


ALTER SCHEMA "postgres-table-has-many-required$dev" OWNER TO root;
...
--
-- Name: Post; Type: TABLE; Schema: postgres-table-has-many-required$dev; Owner: root
--

CREATE TABLE "postgres-table-has-many-required$dev"."Post" (
    id character varying(25) NOT NULL
);


ALTER TABLE "postgres-table-has-many-required$dev"."Post" OWNER TO root;

--
-- Name: User; Type: TABLE; Schema: postgres-table-has-many-required$dev; Owner: root
--

CREATE TABLE "postgres-table-has-many-required$dev"."User" (
    id character varying(25) NOT NULL
);


ALTER TABLE "postgres-table-has-many-required$dev"."User" OWNER TO root;

--
-- Name: _PostToUser; Type: TABLE; Schema: postgres-table-has-many-required$dev; Owner: root
--

CREATE TABLE "postgres-table-has-many-required$dev"."_PostToUser" (
    "A" character varying(25) NOT NULL,
    "B" character varying(25) NOT NULL
);


ALTER TABLE "postgres-table-has-many-required$dev"."_PostToUser" OWNER TO root;
...
--
-- Name: Post Post_pkey; Type: CONSTRAINT; Schema: postgres-table-has-many-required$dev; Owner: root
--

ALTER TABLE ONLY "postgres-table-has-many-required$dev"."Post"
    ADD CONSTRAINT "Post_pkey" PRIMARY KEY (id);


--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: postgres-table-has-many-required$dev; Owner: root
--

ALTER TABLE ONLY "postgres-table-has-many-required$dev"."User"
    ADD CONSTRAINT "User_pkey" PRIMARY KEY (id);


--
-- Name: _PostToUser_AB_unique; Type: INDEX; Schema: postgres-table-has-many-required$dev; Owner: root
--

CREATE UNIQUE INDEX "_PostToUser_AB_unique" ON "postgres-table-has-many-required$dev"."_PostToUser" USING btree ("A", "B");


--
-- Name: _PostToUser_B; Type: INDEX; Schema: postgres-table-has-many-required$dev; Owner: root
--

CREATE INDEX "_PostToUser_B" ON "postgres-table-has-many-required$dev"."_PostToUser" USING btree ("B");
...
--
-- Name: _PostToUser _PostToUser_A_fkey; Type: FK CONSTRAINT; Schema: postgres-table-has-many-required$dev; Owner: root
--

ALTER TABLE ONLY "postgres-table-has-many-required$dev"."_PostToUser"
    ADD CONSTRAINT "_PostToUser_A_fkey" FOREIGN KEY ("A") REFERENCES "postgres-table-has-many-required$dev"."Post"(id) ON DELETE CASCADE;


--
-- Name: _PostToUser _PostToUser_B_fkey; Type: FK CONSTRAINT; Schema: postgres-table-has-many-required$dev; Owner: root
--

ALTER TABLE ONLY "postgres-table-has-many-required$dev"."_PostToUser"
    ADD CONSTRAINT "_PostToUser_B_fkey" FOREIGN KEY ("B") REFERENCES "postgres-table-has-many-required$dev"."User"(id) ON DELETE CASCADE;
