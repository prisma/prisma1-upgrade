...
--
-- Name: postgres-scalar-lists$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres-scalar-lists$dev";


ALTER SCHEMA "postgres-scalar-lists$dev" OWNER TO root;
...
--
-- Name: User; Type: TABLE; Schema: postgres-scalar-lists$dev; Owner: root
--

CREATE TABLE "postgres-scalar-lists$dev"."User" (
    id character varying(25) NOT NULL
);


ALTER TABLE "postgres-scalar-lists$dev"."User" OWNER TO root;

--
-- Name: User_coinflips; Type: TABLE; Schema: postgres-scalar-lists$dev; Owner: root
--

CREATE TABLE "postgres-scalar-lists$dev"."User_coinflips" (
...
CREATE TABLE "postgres-scalar-lists$dev"."User_roles" (
    "nodeId" character varying(25) NOT NULL,
    "position" integer NOT NULL,
    value text NOT NULL
);
...
ALTER TABLE "postgres-scalar-lists$dev"."User_roles" OWNER TO root;
...
--
-- Name: User_coinflips User_coinflips_pkey; Type: CONSTRAINT; Schema: postgres-scalar-lists$dev; Owner: root
--
...
ALTER TABLE ONLY "postgres-scalar-lists$dev"."User"
    ADD CONSTRAINT "User_pkey" PRIMARY KEY (id);


--
-- Name: User_roles User_roles_pkey; Type: CONSTRAINT; Schema: postgres-scalar-lists$dev; Owner: root
--

ALTER TABLE ONLY "postgres-scalar-lists$dev"."User_roles"
...
--
-- Name: User_coinflips User_coinflips_nodeId_fkey; Type: FK CONSTRAINT; Schema: postgres-scalar-lists$dev; Owner: root
--
...
--
-- Name: User_roles User_roles_nodeId_fkey; Type: FK CONSTRAINT; Schema: postgres-scalar-lists$dev; Owner: root
--

ALTER TABLE ONLY "postgres-scalar-lists$dev"."User_roles"
    ADD CONSTRAINT "User_roles_nodeId_fkey" FOREIGN KEY ("nodeId") REFERENCES "postgres-scalar-lists$dev"."User"(id);
