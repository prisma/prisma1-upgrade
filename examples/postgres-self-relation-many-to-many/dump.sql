...
--
-- Name: postgres-self-relation-many-to-many$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres-self-relation-many-to-many$dev";


ALTER SCHEMA "postgres-self-relation-many-to-many$dev" OWNER TO root;
...
--
-- Name: User; Type: TABLE; Schema: postgres-self-relation-many-to-many$dev; Owner: root
--

CREATE TABLE "postgres-self-relation-many-to-many$dev"."User" (
    id character varying(25) NOT NULL,
    "invitedUser" character varying(25)
);


ALTER TABLE "postgres-self-relation-many-to-many$dev"."User" OWNER TO root;
...
--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: postgres-self-relation-many-to-many$dev; Owner: root
--

ALTER TABLE ONLY "postgres-self-relation-many-to-many$dev"."User"
    ADD CONSTRAINT "User_pkey" PRIMARY KEY (id);
...
--
-- Name: User User_invitedUser_fkey; Type: FK CONSTRAINT; Schema: postgres-self-relation-many-to-many$dev; Owner: root
--

ALTER TABLE ONLY "postgres-self-relation-many-to-many$dev"."User"
    ADD CONSTRAINT "User_invitedUser_fkey" FOREIGN KEY ("invitedUser") REFERENCES "postgres-self-relation-many-to-many$dev"."User"(id) ON DELETE SET NULL;
