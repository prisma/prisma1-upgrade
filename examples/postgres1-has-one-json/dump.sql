...
--
-- Name: postgres1-has-one-json$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres1-has-one-json$dev";


ALTER SCHEMA "postgres1-has-one-json$dev" OWNER TO root;
...
--
-- Name: Profile; Type: TABLE; Schema: postgres1-has-one-json$dev; Owner: root
--

CREATE TABLE "postgres1-has-one-json$dev"."Profile" (
...
ALTER TABLE "postgres1-has-one-json$dev"."Profile" OWNER TO root;

--
-- Name: User; Type: TABLE; Schema: postgres1-has-one-json$dev; Owner: root
--

CREATE TABLE "postgres1-has-one-json$dev"."User" (
    id character varying(25) NOT NULL,
    meta text NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL,
    "createdAt" timestamp(3) without time zone NOT NULL
...
ALTER TABLE "postgres1-has-one-json$dev"."User" OWNER TO root;

--
-- Name: _ProfileToUser; Type: TABLE; Schema: postgres1-has-one-json$dev; Owner: root
--

CREATE TABLE "postgres1-has-one-json$dev"."_ProfileToUser" (
...
ALTER TABLE "postgres1-has-one-json$dev"."_ProfileToUser" OWNER TO root;

--
-- Name: _RelayId; Type: TABLE; Schema: postgres1-has-one-json$dev; Owner: root
--

CREATE TABLE "postgres1-has-one-json$dev"."_RelayId" (
    id character varying(36) NOT NULL,
    "stableModelIdentifier" character varying(25) NOT NULL
);


ALTER TABLE "postgres1-has-one-json$dev"."_RelayId" OWNER TO root;
...
--
-- Name: Profile Profile_pkey; Type: CONSTRAINT; Schema: postgres1-has-one-json$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-has-one-json$dev"."Profile"
    ADD CONSTRAINT "Profile_pkey" PRIMARY KEY (id);


--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: postgres1-has-one-json$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-has-one-json$dev"."User"
    ADD CONSTRAINT "User_pkey" PRIMARY KEY (id);


--
-- Name: _ProfileToUser _ProfileToUser_pkey; Type: CONSTRAINT; Schema: postgres1-has-one-json$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-has-one-json$dev"."_ProfileToUser"
    ADD CONSTRAINT "_ProfileToUser_pkey" PRIMARY KEY (id);


--
-- Name: _RelayId pk_RelayId; Type: CONSTRAINT; Schema: postgres1-has-one-json$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-has-one-json$dev"."_RelayId"
    ADD CONSTRAINT "pk_RelayId" PRIMARY KEY (id);


--
-- Name: _ProfileToUser_AB_unique; Type: INDEX; Schema: postgres1-has-one-json$dev; Owner: root
--

CREATE UNIQUE INDEX "_ProfileToUser_AB_unique" ON "postgres1-has-one-json$dev"."_ProfileToUser" USING btree ("A", "B");


--
-- Name: _ProfileToUser_B; Type: INDEX; Schema: postgres1-has-one-json$dev; Owner: root
--

CREATE INDEX "_ProfileToUser_B" ON "postgres1-has-one-json$dev"."_ProfileToUser" USING btree ("B");
...
--
-- Name: _ProfileToUser _ProfileToUser_A_fkey; Type: FK CONSTRAINT; Schema: postgres1-has-one-json$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-has-one-json$dev"."_ProfileToUser"
    ADD CONSTRAINT "_ProfileToUser_A_fkey" FOREIGN KEY ("A") REFERENCES "postgres1-has-one-json$dev"."Profile"(id) ON DELETE CASCADE;


--
-- Name: _ProfileToUser _ProfileToUser_B_fkey; Type: FK CONSTRAINT; Schema: postgres1-has-one-json$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-has-one-json$dev"."_ProfileToUser"
    ADD CONSTRAINT "_ProfileToUser_B_fkey" FOREIGN KEY ("B") REFERENCES "postgres1-has-one-json$dev"."User"(id) ON DELETE CASCADE;
