...
--
-- Name: postgres-table-has-many$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres-table-has-many$dev";


ALTER SCHEMA "postgres-table-has-many$dev" OWNER TO root;
...
--
-- Name: Post; Type: TABLE; Schema: postgres-table-has-many$dev; Owner: root
--

CREATE TABLE "postgres-table-has-many$dev"."Post" (
    id character varying(25) NOT NULL
);


ALTER TABLE "postgres-table-has-many$dev"."Post" OWNER TO root;

--
-- Name: User; Type: TABLE; Schema: postgres-table-has-many$dev; Owner: root
--

CREATE TABLE "postgres-table-has-many$dev"."User" (
    id character varying(25) NOT NULL
);


ALTER TABLE "postgres-table-has-many$dev"."User" OWNER TO root;

--
-- Name: _PostToUser; Type: TABLE; Schema: postgres-table-has-many$dev; Owner: root
--

CREATE TABLE "postgres-table-has-many$dev"."_PostToUser" (
    "A" character varying(25) NOT NULL,
    "B" character varying(25) NOT NULL
);


ALTER TABLE "postgres-table-has-many$dev"."_PostToUser" OWNER TO root;
...
--
-- Name: Post Post_pkey; Type: CONSTRAINT; Schema: postgres-table-has-many$dev; Owner: root
--

ALTER TABLE ONLY "postgres-table-has-many$dev"."Post"
    ADD CONSTRAINT "Post_pkey" PRIMARY KEY (id);


--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: postgres-table-has-many$dev; Owner: root
--

ALTER TABLE ONLY "postgres-table-has-many$dev"."User"
    ADD CONSTRAINT "User_pkey" PRIMARY KEY (id);


--
-- Name: _PostToUser_AB_unique; Type: INDEX; Schema: postgres-table-has-many$dev; Owner: root
--

CREATE UNIQUE INDEX "_PostToUser_AB_unique" ON "postgres-table-has-many$dev"."_PostToUser" USING btree ("A", "B");


--
-- Name: _PostToUser_B; Type: INDEX; Schema: postgres-table-has-many$dev; Owner: root
--

CREATE INDEX "_PostToUser_B" ON "postgres-table-has-many$dev"."_PostToUser" USING btree ("B");
...
--
-- Name: _PostToUser _PostToUser_A_fkey; Type: FK CONSTRAINT; Schema: postgres-table-has-many$dev; Owner: root
--

ALTER TABLE ONLY "postgres-table-has-many$dev"."_PostToUser"
    ADD CONSTRAINT "_PostToUser_A_fkey" FOREIGN KEY ("A") REFERENCES "postgres-table-has-many$dev"."Post"(id) ON DELETE CASCADE;


--
-- Name: _PostToUser _PostToUser_B_fkey; Type: FK CONSTRAINT; Schema: postgres-table-has-many$dev; Owner: root
--

ALTER TABLE ONLY "postgres-table-has-many$dev"."_PostToUser"
    ADD CONSTRAINT "_PostToUser_B_fkey" FOREIGN KEY ("B") REFERENCES "postgres-table-has-many$dev"."User"(id) ON DELETE CASCADE;
