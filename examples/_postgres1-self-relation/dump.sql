...
--
-- Name: postgres1-self-relation$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres1-self-relation$dev";


ALTER SCHEMA "postgres1-self-relation$dev" OWNER TO root;
...
--
-- Name: User; Type: TABLE; Schema: postgres1-self-relation$dev; Owner: root
--

CREATE TABLE "postgres1-self-relation$dev"."User" (
...
ALTER TABLE "postgres1-self-relation$dev"."User" OWNER TO root;

--
-- Name: _RelayId; Type: TABLE; Schema: postgres1-self-relation$dev; Owner: root
--

CREATE TABLE "postgres1-self-relation$dev"."_RelayId" (
    id character varying(36) NOT NULL,
    "stableModelIdentifier" character varying(25) NOT NULL
);


ALTER TABLE "postgres1-self-relation$dev"."_RelayId" OWNER TO root;

--
-- Name: _UserInvitation; Type: TABLE; Schema: postgres1-self-relation$dev; Owner: root
--

CREATE TABLE "postgres1-self-relation$dev"."_UserInvitation" (
...
ALTER TABLE "postgres1-self-relation$dev"."_UserInvitation" OWNER TO root;
...
--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: postgres1-self-relation$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-self-relation$dev"."User"
    ADD CONSTRAINT "User_pkey" PRIMARY KEY (id);


--
-- Name: _UserInvitation _UserInvitation_pkey; Type: CONSTRAINT; Schema: postgres1-self-relation$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-self-relation$dev"."_UserInvitation"
    ADD CONSTRAINT "_UserInvitation_pkey" PRIMARY KEY (id);


--
-- Name: _RelayId pk_RelayId; Type: CONSTRAINT; Schema: postgres1-self-relation$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-self-relation$dev"."_RelayId"
    ADD CONSTRAINT "pk_RelayId" PRIMARY KEY (id);


--
-- Name: _UserInvitation_AB_unique; Type: INDEX; Schema: postgres1-self-relation$dev; Owner: root
--

CREATE UNIQUE INDEX "_UserInvitation_AB_unique" ON "postgres1-self-relation$dev"."_UserInvitation" USING btree ("A", "B");


--
-- Name: _UserInvitation_B; Type: INDEX; Schema: postgres1-self-relation$dev; Owner: root
--

CREATE INDEX "_UserInvitation_B" ON "postgres1-self-relation$dev"."_UserInvitation" USING btree ("B");
...
--
-- Name: _UserInvitation _UserInvitation_A_fkey; Type: FK CONSTRAINT; Schema: postgres1-self-relation$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-self-relation$dev"."_UserInvitation"
    ADD CONSTRAINT "_UserInvitation_A_fkey" FOREIGN KEY ("A") REFERENCES "postgres1-self-relation$dev"."User"(id) ON DELETE CASCADE;


--
-- Name: _UserInvitation _UserInvitation_B_fkey; Type: FK CONSTRAINT; Schema: postgres1-self-relation$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-self-relation$dev"."_UserInvitation"
    ADD CONSTRAINT "_UserInvitation_B_fkey" FOREIGN KEY ("B") REFERENCES "postgres1-self-relation$dev"."User"(id) ON DELETE CASCADE;
