...
--
-- Host: 0.0.0.0    Database: mysql1-all@dev
-- ------------------------------------------------------
...
--
-- Table structure for table `_UserPost`
--

DROP TABLE IF EXISTS `_UserPost`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_UserPost` (
  ...
  KEY `B` (`B`),
  CONSTRAINT `_UserPost_ibfk_1` FOREIGN KEY (`A`) REFERENCES `Post` (`id`) ON DELETE CASCADE,
  CONSTRAINT `_UserPost_ibfk_2` FOREIGN KEY (`B`) REFERENCES `User` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `_UserProfile`
--

DROP TABLE IF EXISTS `_UserProfile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_UserProfile` (
  ...
  KEY `B` (`B`),
  CONSTRAINT `_UserProfile_ibfk_1` FOREIGN KEY (`A`) REFERENCES `Profile` (`id`) ON DELETE CASCADE,
  CONSTRAINT `_UserProfile_ibfk_2` FOREIGN KEY (`B`) REFERENCES `User` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-07-01 12:04:55