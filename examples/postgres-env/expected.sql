ALTER TABLE "postgres-env$dev"."User" ALTER COLUMN "id" SET DATA TYPE varchar(30);
...
ALTER TABLE "postgres-env$dev"."Post" ALTER COLUMN "id" SET DATA TYPE varchar(30);
...
ALTER TABLE "postgres-env$dev"."Profile" ALTER COLUMN "id" SET DATA TYPE varchar(30);
ALTER TABLE "postgres-env$dev"."Category" ALTER COLUMN "id" SET DATA TYPE varchar(30);
