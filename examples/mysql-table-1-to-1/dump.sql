...
--
-- Host: 0.0.0.0    Database: mysql-table-1-to-1@dev
-- ------------------------------------------------------
...
CREATE TABLE `_Settings` (
  ...
  CONSTRAINT `_Settings_ibfk_2` FOREIGN KEY (`B`) REFERENCES `User` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-12 15:47:10