...
UPDATE "postgres-alias$dev"."Post" SET "authorId" = "postgres-alias$dev"."_MessageToUser"."A" FROM "postgres-alias$dev"."_MessageToUser" WHERE "postgres-alias$dev"."_MessageToUser"."B" = "postgres-alias$dev"."Post"."id";
