...
--
-- Name: postgres1-scalar-lists$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres1-scalar-lists$dev";


ALTER SCHEMA "postgres1-scalar-lists$dev" OWNER TO root;
...
--
-- Name: User; Type: TABLE; Schema: postgres1-scalar-lists$dev; Owner: root
--

CREATE TABLE "postgres1-scalar-lists$dev"."User" (
...
ALTER TABLE "postgres1-scalar-lists$dev"."User" OWNER TO root;

--
-- Name: User_coinflips; Type: TABLE; Schema: postgres1-scalar-lists$dev; Owner: root
--

CREATE TABLE "postgres1-scalar-lists$dev"."User_coinflips" (
...
ALTER TABLE "postgres1-scalar-lists$dev"."User_coinflips" OWNER TO root;

--
-- Name: User_roles; Type: TABLE; Schema: postgres1-scalar-lists$dev; Owner: root
--

CREATE TABLE "postgres1-scalar-lists$dev"."User_roles" (
    "nodeId" character varying(25) NOT NULL,
    "position" integer NOT NULL,
    value text NOT NULL
);
...
ALTER TABLE "postgres1-scalar-lists$dev"."User_roles" OWNER TO root;

--
-- Name: _RelayId; Type: TABLE; Schema: postgres1-scalar-lists$dev; Owner: root
--

CREATE TABLE "postgres1-scalar-lists$dev"."_RelayId" (
    id character varying(36) NOT NULL,
    "stableModelIdentifier" character varying(25) NOT NULL
);


ALTER TABLE "postgres1-scalar-lists$dev"."_RelayId" OWNER TO root;
...
--
-- Name: User_coinflips User_coinflips_pkey; Type: CONSTRAINT; Schema: postgres1-scalar-lists$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-scalar-lists$dev"."User_coinflips"
    ADD CONSTRAINT "User_coinflips_pkey" PRIMARY KEY ("nodeId", "position");


--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: postgres1-scalar-lists$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-scalar-lists$dev"."User"
    ADD CONSTRAINT "User_pkey" PRIMARY KEY (id);


--
-- Name: User_roles User_roles_pkey; Type: CONSTRAINT; Schema: postgres1-scalar-lists$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-scalar-lists$dev"."User_roles"
    ADD CONSTRAINT "User_roles_pkey" PRIMARY KEY ("nodeId", "position");


--
-- Name: _RelayId pk_RelayId; Type: CONSTRAINT; Schema: postgres1-scalar-lists$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-scalar-lists$dev"."_RelayId"
...
--
-- Name: User_coinflips User_coinflips_nodeId_fkey; Type: FK CONSTRAINT; Schema: postgres1-scalar-lists$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-scalar-lists$dev"."User_coinflips"
    ADD CONSTRAINT "User_coinflips_nodeId_fkey" FOREIGN KEY ("nodeId") REFERENCES "postgres1-scalar-lists$dev"."User"(id);


--
-- Name: User_roles User_roles_nodeId_fkey; Type: FK CONSTRAINT; Schema: postgres1-scalar-lists$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-scalar-lists$dev"."User_roles"
    ADD CONSTRAINT "User_roles_nodeId_fkey" FOREIGN KEY ("nodeId") REFERENCES "postgres1-scalar-lists$dev"."User"(id);
