...
--
-- Host: 0.0.0.0    Database: mysql-alias@dev
-- ------------------------------------------------------
...
--
-- Table structure for table `_CategoryToMessage`
--

DROP TABLE IF EXISTS `_CategoryToMessage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_CategoryToMessage` (
  ...
  CONSTRAINT `_CategoryToMessage_ibfk_2` FOREIGN KEY (`B`) REFERENCES `Post` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `_MessageToUser`
--
...
CREATE TABLE `_MessageToUser` (
  ...
  CONSTRAINT `_MessageToUser_ibfk_2` FOREIGN KEY (`B`) REFERENCES `User` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-08 16:20:08