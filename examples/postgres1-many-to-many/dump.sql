...
--
-- Name: postgres1-has-one-optional$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres1-has-one-optional$dev";


ALTER SCHEMA "postgres1-has-one-optional$dev" OWNER TO root;

--
-- Name: postgres1-many-to-many$dev; Type: SCHEMA; Schema: -; Owner: root
--

CREATE SCHEMA "postgres1-many-to-many$dev";


ALTER SCHEMA "postgres1-many-to-many$dev" OWNER TO root;
...
CREATE TABLE "postgres1-has-one-optional$dev"."User" (
    id character varying(25) NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL,
    "createdAt" timestamp(3) without time zone NOT NULL
);
...
CREATE TABLE "postgres1-has-one-optional$dev"."_RelayId" (
    id character varying(36) NOT NULL,
    "stableModelIdentifier" character varying(25) NOT NULL
);


ALTER TABLE "postgres1-has-one-optional$dev"."_RelayId" OWNER TO root;

--
-- Name: Post; Type: TABLE; Schema: postgres1-many-to-many$dev; Owner: root
--

CREATE TABLE "postgres1-many-to-many$dev"."Post" (
    id character varying(25) NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL,
    "createdAt" timestamp(3) without time zone NOT NULL
);
...
CREATE TABLE "postgres1-many-to-many$dev"."_RelayId" (
    id character varying(36) NOT NULL,
    "stableModelIdentifier" character varying(25) NOT NULL
);


ALTER TABLE "postgres1-many-to-many$dev"."_RelayId" OWNER TO root;
...
--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: postgres1-has-one-optional$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-has-one-optional$dev"."User"
    ADD CONSTRAINT "User_pkey" PRIMARY KEY (id);
...
--
-- Name: _RelayId pk_RelayId; Type: CONSTRAINT; Schema: postgres1-has-one-optional$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-has-one-optional$dev"."_RelayId"
    ADD CONSTRAINT "pk_RelayId" PRIMARY KEY (id);


--
-- Name: Post Post_pkey; Type: CONSTRAINT; Schema: postgres1-many-to-many$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-many-to-many$dev"."Post"
...
--
-- Name: _RelayId pk_RelayId; Type: CONSTRAINT; Schema: postgres1-many-to-many$dev; Owner: root
--

ALTER TABLE ONLY "postgres1-many-to-many$dev"."_RelayId"
    ADD CONSTRAINT "pk_RelayId" PRIMARY KEY (id);
