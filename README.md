...
We spent a lot of time on this tool and are pretty happy with the results. It's working and well-tested but you may need to make some manual adjustments to clean some odds and ends up. We recommend you download the [Prisma 2 VSCode extension](https://marketplace.visualstudio.com/items?itemName=Prisma.prisma) to help you with this. You should always run the SQL generated by this tool on your test or staging databases before running it on production.
