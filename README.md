...
We spent a lot of time on this tool and are pretty happy with the results. It's working and well-tested but you may need to make some manual adjustments to clean up some odds and ends. We recommend you download the [Prisma 2 VSCode extension](https://marketplace.visualstudio.com/items?itemName=Prisma.prisma) to help with your transition. 
